...
//                    showComment(true);
    ...
    private void showComment(boolean isVideoFullScreen) {
        ...
        if (isVideoFullScreen) {
            ...
            if (translationSecondOffset == 0) {
                translationSecondOffset = (int) (iv_live.getY() - ScreenUtil.dp2px(44));
            }
            ObjectAnimator translationYCommentFirst = ObjectAnimator.ofFloat(commentContainer, View.TRANSLATION_Y, ScreenUtil.dp2px(commentContainer.getHeight()), ScreenUtil.dp2px(157)).setDuration(durationOne);
            ObjectAnimator translationYCommentSecond = ObjectAnimator.ofFloat(commentContainer, View.TRANSLATION_Y, translationSecondOffset, 0).setDuration(durationTwo);
            ObjectAnimator translationY = ObjectAnimator.ofFloat(iv_live, View.TRANSLATION_Y, 0, -translationSecondOffset).setDuration(durationTwo);
    ...
    private void hideComment(boolean isVideoFullScreen) {
        ...
        if (isVideoFullScreen) {
            ...
            ObjectAnimator translationYCommentFirst = ObjectAnimator.ofFloat(commentContainer, View.TRANSLATION_Y, 0, translationSecondOffset).setDuration(durationTwo);
            ObjectAnimator translationYCommentSecond = ObjectAnimator.ofFloat(commentContainer, View.TRANSLATION_Y, translationSecondOffset, ScreenUtil.dp2px(commentContainer.getHeight())).setDuration(durationOne);
            ObjectAnimator translationY = ObjectAnimator.ofFloat(iv_live, View.TRANSLATION_Y, -translationSecondOffset, 0).setDuration(durationTwo);
//            AnimatorSet set1 = new AnimatorSet();
//            set1.playTogether(translationY, translationYCommentFirst);
//            set.play(translationYCommentSecond).after(set1);
