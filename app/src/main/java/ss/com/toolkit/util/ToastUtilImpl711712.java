...
public class ToastUtilImpl711712 {
    ...
    private static ToastCompat mTopToast;
    private static ToastCompat mBottomToast;
    private static ToastCompat mCustomToast;
    ...
    public static void show(final int resId) {
        if (ToastUtil.invalidToast()) return;

        if (mBottomToast != null) {
            mBottomToast.cancel();
        }

        mBottomToast = ToastCompat.makeText(mContext, mContext.getResources().getString(resId), Toast.LENGTH_SHORT);
    ...
    public static void show(final String msg) {
        ...
        mBottomToast = ToastCompat.makeText(mContext, msg, Toast.LENGTH_SHORT);
        fixToastBadTokenException(mBottomToast);
        mBottomToast.show();
    }
    ...
    public static void show(final String msg, final int len) {
        ...
        mBottomToast = ToastCompat.makeText(mContext, msg, len);
        fixToastBadTokenException(mBottomToast);
        mBottomToast.show();
    }
    ...
    public static void showToast(String msg, int len) {
        ...
        mBottomToast = new ToastCompat(mContext);
        fixToastBadTokenException(mBottomToast);
        mBottomToast.show();
    }
    ...
    public static void showToastTop(String msg) {
        ...
        mTopToast = ToastCompat.makeText(mContext, msg, Toast.LENGTH_SHORT);
    ...
    public static void showRedTopToast(String msg, int yoffset) {
        ...
        mCustomToast = new ToastCompat(mContext);
    ...
    //Toast自定义View固定布局
    public static Toast showCustomToast(int layout, int time, ToastUtil.ToastViewCallback callback) {
        if (ToastUtil.invalidToast()) return null;
